...
TIER_TABLE = [
    ...
    (2_000_000_000, "챌린저",   "🏆", 0.008, 122000, 8.0, 0.40, 31),
    (1_200_000_000, "그랜드마스터", "⚜️", 0.01, 112000, 6.0, 0.45, 30),
    (700_000_000,   "마스터",   "🔥", 0.012, 105000, 5.0, 0.50, 29),
    (450_000_000,   "다이아1",  "💎", 0.015, 98000, 4.0, 0.55, 28),
    (320_000_000,   "다이아2",  "💎", 0.018, 94000, 3.5, 0.58, 27),
    (220_000_000,   "다이아3",  "💎", 0.02, 91000, 3.2, 0.60, 26),
    (150_000_000,   "다이아4",  "💎", 0.022, 88000, 3.0, 0.62, 25),
    (100_000_000,   "에메랄드1","💚", 0.025, 84000, 2.8, 0.65, 24),
    (75_000_000,    "에메랄드2","💚", 0.028, 82000, 2.5, 0.68, 23),
    (55_000_000,    "에메랄드3","💚", 0.03, 80000, 2.3, 0.70, 22),
    (40_000_000,    "에메랄드4","💚", 0.032, 79000, 2.1, 0.72, 21),
    (28_000_000,    "플래티넘1","💠", 0.035, 77000, 2.0, 0.75, 20),
    (20_000_000,    "플래티넘2","💠", 0.038, 75000, 1.8, 0.78, 19),
    (14_000_000,    "플래티넘3","💠", 0.04, 74000, 1.6, 0.80, 18),
    (10_000_000,    "플래티넘4","💠", 0.042, 72000, 1.5, 0.82, 17),
    (7_000_000,     "골드1",   "🥇", 0.045, 70000, 1.4, 0.85, 16),
    (5_000_000,     "골드2",   "🥇", 0.048, 68000, 1.3, 0.87, 15),
    (3_500_000,     "골드3",   "🥇", 0.05, 66000, 1.25,0.88, 14),
    (2_500_000,     "골드4",   "🥇", 0.05, 65000, 1.2, 0.90, 13),
    (1_800_000,     "실버1",   "🥈", 0.052, 63000, 1.15,0.91, 12),
    (1_300_000,     "실버2",   "🥈", 0.053, 61000, 1.1, 0.92, 11),
    (900_000,       "실버3",   "🥈", 0.055, 59000, 1.08,0.93, 10),
    (600_000,       "실버4",   "🥈", 0.055, 58000, 1.05,0.94,  9),
    (400_000,       "브론즈1", "🥉", 0.057, 56000, 1.0, 0.95,  8),
    (250_000,       "브론즈2", "🥉", 0.058, 54000, 1.0, 0.96,  7),
    (150_000,       "브론즈3", "🥉", 0.06, 52000, 1.0, 0.97,  6),
    (80_000,        "브론즈4", "🥉", 0.06, 51000, 1.0, 0.98,  5),
    (40_000,        "아이언1", "⚙️", 0.06, 49000, 1.0, 0.99,  4),
    (15_000,        "아이언2", "⚙️", 0.06, 47000, 1.0, 1.00,  3),
    (5_000,         "아이언3", "⚙️", 0.06, 46000, 1.0, 1.00,  2),
    (0,             "아이언4", "⚙️", 0.06, 42000, 1.0, 1.00,  1),
]
